...
export const THREAD_MESSAGE_COMPOSED = "threadMessageComposed";
export const THREAD_MESSAGE_DELETED = "threadMessageDeleted";
export const UPDATE_THREAD_MESSAGE = "updateThreadMessage";
...
export const CUSTOM_MESSAGE_RECEIVED = "customMessageReceived";
