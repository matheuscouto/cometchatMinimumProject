...
export default (props) => {
  ...
  const checkRestrictions = async () => {
    let isChangingGroupMemberScopeEnabled =
      await context.FeatureRestriction.isChangingGroupMemberScopeEnabled();
    let isKickingGroupMembersEnabled =
      await context.FeatureRestriction.isKickingGroupMembersEnabled();
    let isBanningGroupMembersEnabled =
      await context.FeatureRestriction.isBanningGroupMembersEnabled();
    setRestrictions({
