...
class CometChatGroupList extends React.Component {
  ...
  checkRestrictions = async () => {
    ...
    let isGroupSearchEnabled =
      await context.FeatureRestriction.isGroupSearchEnabled();
    let isGroupCreationEnabled =
      await context.FeatureRestriction.isGroupCreationEnabled();
    let isJoinLeaveGroupsEnabled =
      await context.FeatureRestriction.isJoinLeaveGroupsEnabled();
    this.setState({
      restrictions: {
